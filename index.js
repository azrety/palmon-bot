...
if (cmd === "perefloflo") {
  ...
  const intros = [
    ...
    "🐉 Le dragon de Père Floflo se gare difficilement devant la taverne...",
    "🌙 La nuit tombe sur le serveur… Père Floflo commence son récit.",
    "⚔️ Les guerriers se taisent. Même les plus débiles écoutent Père Floflo.",
    "🧙 Père Floflo ajuste sa robe magique tachée de sauce.",
    "📜 Un vieux parchemin interdit vient d’être déroulé…",
    ...
    "🍷 Père Floflo prétend être sobre aujourd’hui. Personne ne le croit.",
    "🐀 Même les rats de la taverne arrêtent de bouger pour écouter.",
    "🌪️ Une odeur de dragon humide envahit soudainement la pièce…",
    "📖 Père Floflo revient du serveur 150 avec un récit inquiétant.",
    "⚰️ Père Floflo affirme que cette histoire est “totalement vraie”.",
    "🧠 Père Floflo a eu une idée. C’est rarement bon signe.",
    "🔔 Le grand moment est venu… Père Floflo raconte ENCORE une histoire.",
    "🍺 Père Floflo frappe la table si fort qu’une chope explose.",
    "🐉 Le dragon de Père Floflo refuse d’écouter cette histoire.",
