...
if (cmd === "perefloflo") {
  ...
  const intros = [
    ...
    "🐉 Le dragon de Père Floflo refuse d’écouter cette histoire. Mais empçeche qui que ce soit d'autres de ne pas l'écouter!!",
    ...
    "🕯️ Une bougie s’éteint toute seule… signe inquiétant, n'envisageant pas un bon signe pour le serveur 150 !",
