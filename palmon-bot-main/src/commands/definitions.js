...
function buildCommands() {
  return [
    ...
    new SlashCommandBuilder()
      .setName("teub-royale")
      .setDescription("Lancer une battle royale commentée")
      .addStringOption(o =>
        o.setName("mode")
          .setDescription("Organisation des combats")
          .setRequired(true)
          .addChoices(
            { name: "🎲 Random — tirage à chaque manche", value: "random" },
            { name: "🏆 Bracket — tableau fixe", value: "bracket" }
          )
      )
      .addStringOption(o =>
        o.setName("participants")
          .setDescription("Qui entre dans l'arène ?")
          .setRequired(false)
          .addChoices(
            { name: "Auto — tous les joueurs", value: "auto" },
            { name: "Choisir une liste", value: "choisir" }
          )
      )
      .addStringOption(o =>
        o.setName("joueurs")
          .setDescription("Liste séparée par des virgules (ex. Flo,Bob,Ren)")
          .setRequired(false)
      )
      .addStringOption(o =>
        o.setName("exclure")
          .setDescription("Joueurs à retirer, séparés par des virgules")
          .setRequired(false)
      )
      .addIntegerOption(o =>
        o.setName("delai")
          .setDescription("Secondes entre les messages d'un combat (5 à 10)")
          .setMinValue(5)
          .setMaxValue(10)
          .setRequired(false)
      )
